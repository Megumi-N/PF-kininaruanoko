  ...
  draw() {
    ...
    if (this.x < 0 || this.x > SCREEN_WIDTH - 50) {
      if (
        ...
        <a href="https://twitter.com/intent/tweet?&text=ほかの追随を許さないほどの転がしテクニックを持っています。%0a%0aスマホの傾き検知機能を使って気になるあの子をコロコロしよう。%0aandroid環境推奨。%0a%23気になるあの子%0a%23コロコロ%0a%23気になるあの子をコロコロするだけのアプリ%0a&url=https://affectionate-bohr-19c20b.netlify.app/"
        target="_blank"
